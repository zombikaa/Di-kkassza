    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-sm bg-background overflow-hidden ring-2 ring-muted ring-offset-maincolor focus-within:ring-2 focus-within:ring-maincolor focus-within:ring-offset-2 transition-all duration-100 ease-in-out",
            {
              "focus-within:ring-maincolor": activeIndex === -1,
            },
            className,
          )}
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-1 rounded flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-secondarycolor truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed",
              )}
              variant={"secondary"}
            >
              <span className="text-xs text-secondarycolor">{item}</span>
              <button
                type="button"
